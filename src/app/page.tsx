  ...
  return (
    <div className="flex items-center justify-center h-full">
      ...
      <span style={{color:"blue"}}>Horistics</span>, his brainchildren.</p>
        <p>This the place where you can learn how to identify and solve problems in the best way possible, be they personal or family problems, business problems, economic problems, 
